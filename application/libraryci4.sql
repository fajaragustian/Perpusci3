...
--
-- Host: localhost:3306
-- Generation Time: Aug 08, 2022 at 02:45 PM
...
CREATE TABLE `buku` (
  ...
  `image` varchar(255) NOT NULL DEFAULT 'cover.jpg'
...
(1, 'Cinta Komputer', 1, 'Komputer', 'Penerbit Komputer', 2022, 'ISBN-2022', 11, 1, 0, 'cover.jpg'),
(2, 'Cintai Bahasa', 2, 'Bahasa', 'Penerbit Bahasa', 2010, 'ISBN-2010', 12, 1, 0, 'cover.jpg');
